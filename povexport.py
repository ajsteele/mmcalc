...
# 2010-04-22
# changed this line:
# displayscale = 0.0/(mag(scene.mouse.camera-scene.center)*tan(scene.fov/2.))
# to
# displayscale = 1.0/(mag(display.mouse.camera-display.center)*tan(display.fov/2.))
# to remove error when exporting a scene not called 'scene'


## NOTE: when changing this module please change the following string:
POVEXPORT_VERSION = "povexport 2010-04-22 for Visual 3 and Visual 5"
...
def export(display=None, filename=None, include_list=None, xy_ratio=4./3., custom_text='', shadowless=0):
    ...
    initial_comment = """// POV-ray code generated by povexport.py for MmCalc
