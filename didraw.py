...
def scale(a):
	...
	return numpy.average(numpy.compress(numpy.ravel(a > 0.05*numpy.average(a)), a)) #(ravel flattens an array into 1D)
...
#~ def element_colours(name):
	...
	#~ if name == 'O': return (255.0/255,13.0/255,13.0/255),1
	...
	#~ #if none of those worked, return pure black 998 better colour?
	#~ return (0,0,0)